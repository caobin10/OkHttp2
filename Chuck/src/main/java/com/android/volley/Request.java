...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    private com.android.volley.Cache.Entry mCacheEntry = null;
     ...
     * @return This Request object to allow for chaining.
     */
    public Request<?> setRequestQueue(com.android.volley.RequestQueue requestQueue) {
     ...
     */
    @Deprecated
    protected Map<String, String> getPostParams() throws com.android.volley.AuthFailureError {
        return getParams();
    }
