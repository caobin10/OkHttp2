...
public class Response<T> {
    ...
    public static <T> Response<T> success(T result, com.android.volley.Cache.Entry cacheEntry) {
    ...
    private Response(T result, com.android.volley.Cache.Entry cacheEntry) {
        this.result = result;
